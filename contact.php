    ...
    <div class="section">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mb-5 mb-lg-0" data-aos="fade-up" data-aos-delay="100">
                    <div class="contact-info">
                        ...
                        <div class="address mt-2">
                            ...
                            <p>99 Fremont St, San Francisco CA 94104, USA</p>
                        </div>

                        <div class="email mt-4">
                            <i class="icon-envelope"></i>
                            <h4 class="mb-2">Email:</h4>
                            <p>support@tradovex.com</p>
                        </div>
                ...
                <div style="background-color: #fff; padding: 30px; border-radius: 20px;" class="col-lg-8"
