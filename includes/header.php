...
<body>
    ...
    <nav style="background-color:black; padding-top: 10px;" class="site-nav">
        <div class="container">
                ...
                <div class="site-navigation">
                    <div class="row g-0 align-items-center">
                        ...
                        <div class="col-6 text-center ">
                            <ul class="text-white js-clone-nav d-none d-lg-inline-block text-start site-menu mx-auto">
                                ...
                                <li><a class="text-white" href="index.php#plans">Investment Plans</a></li>
