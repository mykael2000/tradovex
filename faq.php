                ...
                <div class="accordion" id="faqAccordion">
                    ...
                    <div class="card">
                        <div class="card-header" id="faqHeading1">
                            <h5 class="mb-0">
                                <button style="background-color: #fff; color: black;" class="btn btn-link" type="button"
                                    ...
                                    Is tradovex a registered company?
                                </button>
                            </h5>
                        </div>
                        ...
                        <div id="faqCollapse1" class="collapse show" aria-labelledby="faqHeading1"
                            ...
                            <div class="card-body">
                                Yes, tradovex is a registered and legitimate company. We are fully compliant with all
                    ...
                    <div class="card">
                        <div class="card-header" id="faqHeading2">
                            <h5 class="mb-0">
                                <button style="background-color: #fff; color: black;" class="btn btn-link" type="button"
                                    ...
                                    How does tradovex earn profits for its members?
                                </button>
                            </h5>
                        </div>
                        ...
                        <div id="faqCollapse2" class="collapse" aria-labelledby="faqHeading2"
                            data-parent="#faqAccordion">
                            <div class="card-body">
                                tradovex generates profits through strategic investments and trading in various markets,
                    ...
                    <div class="card">
                        ...
                        <div id="faqCollapse15" class="collapse" aria-labelledby="faqHeading15"
                            ...
                            <div class="card-body">
                                ...
                                can
                                send an email to support@tradovex.com.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-header" id="faqHeading16">
                            <h5 class="mb-0">
                                <button style="background-color: #fff; color: black;" class="btn btn-link" type="button"
                                    ...
                                    What do I need to trade on tradovex?
                                </button>
                            </h5>
                        </div>
                        ...
                        <div id="faqCollapse16" class="collapse" aria-labelledby="faqHeading16"
                            data-parent="#faqAccordion">
                            <div class="card-body">
                                To start trading on tradovex, you need to create an account, make a deposit, and then
                                you
                    ...
                    <div class="card">
                        <div class="card-header" id="faqHeading17">
                            <h5 class="mb-0">
                                <button style="background-color: #fff; color: black;" class="btn btn-link" type="button"
                                    ...
                                    How does trading work on tradovex?
                                </button>
                            </h5>
                        </div>
                        ...
                        <div id="faqCollapse17" class="collapse" aria-labelledby="faqHeading17"
                            data-parent="#faqAccordion">
                            <div class="card-body">
                                Trading on tradovex involves buying and selling various assets, such as cryptocurrencies
