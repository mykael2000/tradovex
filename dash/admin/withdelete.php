...
$userid = $_GET['id'];
$sqlUser = "SELECT * FROM withdrawals WHERE id = '$userid'";
...
<form action="" method="post" style="padding:15px;">
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <h4>Are you sure you want to delete transaction #<?php echo $getdetails['tranx_id']; ?>?????</h4>
    </div>
    
  <a href="index.php" style="margin: 10px;" type="submit" class="btn btn-primary">Go back</a>
  <br><br>
  <button style="margin: 10px;" type="submit" name="delete" class="btn btn-primary">Delete transaction</button>
</form>
