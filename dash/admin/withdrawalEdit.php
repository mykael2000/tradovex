...
if(isset($_POST['edit'])){
   ...
   $sqlwith = "UPDATE withdrawals set status = '$newstatus' WHERE id = '$cuserid'";
   $querywith = mysqli_query($con,$sqlwith);
   echo "<script>alert('Withdrawal status updated successfully')</script>";
   header("refresh:1;url=withdrawalEdit.php?id=$cuserid&userid=$userid");
}
...
<div id="main-wrapper">
    ...
    <div class="menu">
        <ul>
            ...
            <li class="logout"><a href="auth/login.php">
                ...
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-auto">
                        ...
                        class="ri-arrow-right-s-line"></i></span><a href="edit.php?id=<?php echo $userid; ?>">Dashboard</a><span><i
                                    class="ri-arrow-right-s-line"></i></span><a href="#">Withdrawal Edit</a></div>
                    </div>
                </div>
            </div>
            <div class="col-xl-12">
                                ...
                                <div class="card-body">
                                    <form method="post" action = "" name="myform" class="personal_validate" novalidate="novalidate">
                                        <div class="row g-4">
                                            ...
                                            <div class="col-12">
                                                <button name = "edit" class="btn btn-primary pl-5 pr-5">Edit Withdrawal</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
