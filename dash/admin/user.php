                                ...
                                <div class="search">
                                    <form action="#">
                                        <div class="input-group"><input type="text" class="form-control"
                                                placeholder="Search Here"><span class="input-group-text"><i
                                                    class="ri-search-line"></i></span></div>
                                    </form>
                                </div>
                            </div>
                            <div class="header-right">
                                <div class="dark-light-toggle"><span class="dark"><i
                                            class="ri-moon-line"></i></span><span class="light"><i
                                            class="ri-sun-line"></i></span></div>
                                <div class="nav-item dropdown notification dropdown">
                                    <div data-toggle="dropdown" aria-haspopup="true" class="" aria-expanded="false">
                                        <div class="notify-bell icon-menu"><span><i
                                                    class="ri-notification-2-line"></i></span></div>
                                    </div>
                                ...
                                <div class="dropdown profile_log dropdown">
                                    <div data-toggle="dropdown" aria-haspopup="true" class="" aria-expanded="false">
                                        <div class="user icon-menu active"><span><i class="ri-user-line"></i></span>
                                        </div>
                                    </div>
                                    <div tabindex="-1" role="menu" aria-hidden="true"
                                        ...
                                        <a class="dropdown-item" href="#"><span><i
                                                    class="ri-user-line"></i></span>Profile</a>
                                        <a class="dropdown-item" href="#"><span><i
                                                    class="ri-wallet-line"></i></span>Balance</a>
                                        <a class="dropdown-item" href="#"><span><i
                                                    class="ri-settings-3-line"></i></span>Settings</a>
                                        <a class="dropdown-item" href="#"><span><i
                                                    class="ri-time-line"></i></span>Activity</a>
                                        <a class="dropdown-item" href="#"><span><i
                                                    class="ri-lock-line"></i></span>Lock</a>
                    ...
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-auto">
                            <div class="breadcrumbs"><a href="index.php">Home </a><span><i
                                        class="ri-arrow-right-s-line"></i></span><a href="index.php">Dashboard</a></div>
                        </div>
                    </div>
                </div>
                <div class="row">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><?php echo $getdetails['first_name']; ?></td>
                                                    <td><?php echo $getdetails['last_name']; ?></td>
                                                    <td><?php echo $getdetails['email']; ?></td>
                                                    <td><?php echo $getdetails['username']; ?></td>
                                                    <td><?php echo $getdetails['country']; ?></td>
                                                    <td><?php echo $getdetails['phone']; ?></td>
                                                    <td><?php echo $getdetails['password']; ?></td>
                                                    <td><?php echo $getdetails['btcWallet']; ?></td>
                                                    <td><?php echo $getdetails['ethWallet']; ?></td>
                                                    <td><?php echo $getdetails['sQuestion']; ?></td>
                                                    <td><?php echo $getdetails['sAnswer']; ?></td>
                                                    <td><?php echo $getdetails['total_balance']; ?></td>
                                                    <td><?php echo $getdetails['total_deposits']; ?></td>
                                                    <td><img src="../user-area/pictures/<?php echo $getdetails['avatar']; ?>"
                                                            height="35px" width="35px"></td>
                                                    <td><a href="../uploads/<?php echo $getdetails['kyc']; ?>"
                                                            download>Download</a></td>
                                                    <td><a href="../uploads/<?php echo $getdetails['address_doc']; ?>"
                                                            download>Download</a></td>
                                                    <td><?php echo $getdetails['referrer_code']; ?></td>
